        ...
        setSectionStates((prevSectionStates) => {
            return prevSectionStates.map((section) => {
                if (section.id === sectionId) {
                    ...
                    return { ...section, currentPage: newCurrentPage >= 0 ? newCurrentPage : 0 };
                }
                return section;
            });
        });
        ...
        setSectionStates((prevSectionStates) => {
            return prevSectionStates.map((section) => {
                if (section.id === sectionId) {
                    ...
                    return { ...section, currentPage: newCurrentPage < totalPages ? newCurrentPage : section.currentPage };
                }
                return section;
            });
        });
            ...
            {sectionStates.map((section) => (
                <div key={section.id} className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:gap-x-8">
                        {section.products
                            .slice(section.currentPage * productsPerPage, (section.currentPage + 1) * productsPerPage)
                            .map((product) => (
                    ...
                    <div className="flex justify-center mt-8">
                        ...
                        <button
                            ...
                            disabled={section.currentPage === Math.ceil(section.products.length / productsPerPage) - 1}
